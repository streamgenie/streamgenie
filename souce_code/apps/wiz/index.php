...
echo '<iframe width="80%" height="100%" src="player.php?channel=' . htmlspecialchars($_GET["channel"]) . '" frameborder="0" scrolling="no" allowfullscreen></iframe>';
} else {
    echo '<iframe width="100%" height=100%" src="/apps/wiz/schedulebox.php" scrolling="no" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
}
?>
				</div>
